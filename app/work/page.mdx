...
<Small>Research Engineering, June 2025 – Present</Small>
- Working on scaling RL verifiers for LLMs, improving test-time compute and evals.
- Trained custom reward models for calibrated reasoning, improving overall accuracy on math and coding tasks.
